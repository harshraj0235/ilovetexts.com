          ...
          <section className="related-tools">
            ...
            <div className="related-tools-grid">
              {relatedTools.map((rt, idx) => (
                <Link key={`${rt.categoryId || category.id}-${rt.slug}-${idx}`} href={lp(`/${rt.categoryId || category.id}/${rt.slug}`)} className="related-tool-card">
          ...
          <section className="related-tools">
            ...
            <div className="related-tools-grid">
              {crossLinks.map((cl, idx) => (
                <Link key={`${cl.categoryId}-${cl.slug}-${idx}`} href={lp(`/${cl.categoryId}/${cl.slug}`)} className="related-tool-card">
