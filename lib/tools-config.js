...
export const CATEGORIES = [
  ...
  },
  {
    ...
    color: '#8b5cf6',
    tools: [
      { slug: 'word-counter', name: 'Word Counter & Text Analyzer', description: 'Count words, characters, selected text, reading time, repeated phrases, and writing goals', icon: '📊', keywords: 'free word counter and character counter online with reading time' },
