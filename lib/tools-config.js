...
export const CATEGORIES = [
  ...
  },
  {
    ...
    color: '#6366f1',
    tools: [
      { slug: 'uppercase', name: 'Uppercase Converter', description: 'Change any text to ALL CAPS instantly', icon: '⬆️', keywords: 'convert text to uppercase online, make all letters capital generator, change to all caps online free' },
      { slug: 'lowercase', name: 'Lowercase Converter', description: 'Change capital letters to lowercase instantly', icon: '⬇️', keywords: 'convert uppercase to lowercase online, small letters text generator, make all letters lowercase free' },
      { slug: 'title-case', name: 'Title Case Converter', description: 'Format your essay titles and headlines correctly', icon: '📝', keywords: 'title case converter online free, AP style headline capitalization, APA style title case generator' },
      { slug: 'sentence-case', name: 'Sentence Case Converter', description: 'Fix broken capitalization by converting text to Sentence case', icon: '✏️', keywords: 'sentence case converter online free, capitalize first letter of sentence, fix capitalization errors in text' },
      { slug: 'camel-case', name: 'camelCase Converter', description: 'Convert any text, spaced string, or snake_case variable into camelCase instantly', icon: '🐪', keywords: 'convert text to camelCase online, string to camelCase generator, camel case variable formatter' },
      { slug: 'snake-case', name: 'snake_case Converter', description: 'Convert spaced text or camelCase into snake_case instantly', icon: '🐍', keywords: 'convert text to snake_case online free, string to snake case generator, replace spaces with underscores tool' },
      ...
      { slug: 'alternating-case', name: 'Alternating Case', description: 'Convert your text to alternating uppercase and lowercase letters instantly', icon: '🔀', keywords: 'alternating case text generator, capital and lowercase letter maker, sarcasm text generator online' },
      { slug: 'toggle-case', name: 'Toggle / Inverse Case', description: 'Instantly swap the capitalization of your text', icon: '🔃', keywords: 'toggle case text converter, swap uppercase and lowercase letters, inverse case generator online free' },
  ...
  },
  {
    ...
    color: '#8b5cf6',
    tools: [
      { slug: 'word-counter', name: 'Word Counter & Text Analyzer', description: 'Count words, characters, sentences, and paragraphs instantly', icon: '📊', keywords: 'word counter online free, how many words in my essay, character counter for instagram' },
      { slug: 'character-counter', name: 'Character Counter', description: 'Count characters with and without spaces', icon: '🔠', keywords: 'character counter online free, count characters with spaces, twitter character limit checker' },
      { slug: 'syllable-counter', name: 'Syllable Counter', description: 'Count the number of syllables in a word, sentence, or entire essay instantly', icon: '🗣️', keywords: 'syllable counter online free, how many syllables in a word, count syllables in text' },
      { slug: 'sentence-counter', name: 'Sentence Counter', description: 'Count the number of sentences in your text instantly', icon: '📏', keywords: 'sentence counter online free, count sentences in paragraph, how many sentences in my essay' },
      { slug: 'paragraph-counter', name: 'Paragraph Counter', description: 'Count the number of paragraphs in your essay, article, or document instantly', icon: '📃', keywords: 'paragraph counter online free, count paragraphs in text, how many paragraphs is 500 words' },
      { slug: 'line-counter', name: 'Line Counter', description: 'Count the number of lines in a text file, code snippet, or document', icon: '📋', keywords: 'line counter online free, count lines of code online, how many lines in text file' },
      { slug: 'word-frequency', name: 'Word Frequency Counter', description: 'Find the most frequently used words and phrases in your text', icon: '📈', keywords: 'word frequency counter online, find most used words in text, repeated word checker' },
      { slug: 'reading-time', name: 'Reading Time Calculator', description: 'Calculate the exact reading time of your article, blog post, or book chapter', icon: '⏱️', keywords: 'reading time calculator online, how long to read my article, blog post read time estimator' },
      { slug: 'speaking-time', name: 'Speaking Time Calculator', description: 'Calculate how long it will take to read your speech, script, or presentation out loud', icon: '🎤', keywords: 'speaking time calculator online, how long is a 1000 word speech, presentation length estimator' },
      { slug: 'readability-score', name: 'Readability Score', description: 'Check the reading level of your text using Flesch-Kincaid, Gunning Fog, and SMOG indexes', icon: '📖', keywords: 'readability score checker free, flesch kincaid grade level test, reading difficulty calculator' },
      { slug: 'keyword-density', name: 'Keyword Density Checker', description: 'Analyze the keyword density of your content for SEO', icon: '🎯', keywords: 'keyword density checker free, seo text analyzer tool, check keyword stuffing online' },
      { slug: 'text-summarizer', name: 'Text Summarizer & Extractor', description: 'Automatically summarize long articles, essays, and text into key sentences', icon: '📝', keywords: 'text summarizer online free, summarize long article instantly, essay summary generator' },
    ],
  },
  {
    id: 'text-cleaner',
    ...
    color: '#ec4899',
    tools: [
      { slug: 'remove-line-breaks', name: 'Remove Line Breaks', description: 'Remove line breaks, convert to <br> tags, and fix broken PDF capitalization', icon: '↩️', keywords: 'remove line breaks from pdf text online free, convert line breaks to spaces, replace line breaks with br tags' },
      ...
      { slug: 'remove-duplicate-lines', name: 'Remove Duplicate Lines', description: 'Remove duplicate lines from text, lists, or code', icon: '🚫', keywords: 'remove duplicate lines from text online free, delete duplicate words in list, filter duplicate rows online' },
      { slug: 'remove-empty-lines', name: 'Remove Empty Lines', description: 'Remove blank lines, empty rows, and whitespace-only lines from text instantly', icon: '🗑️', keywords: 'remove empty lines from text online free, delete blank lines online tool, remove whitespace lines online' },
      { slug: 'remove-whitespace', name: 'Remove All Whitespace', description: 'Remove all spaces, tabs, and whitespace characters from text', icon: '✂️', keywords: 'remove all whitespace from text online free, delete spaces between words online, strip spaces from string online' },
      { slug: 'add-line-numbers', name: 'Add Line Numbers', description: 'Add sequential line numbers to text or code', icon: '🔢', keywords: 'add line numbers to text online free, number lines of code online, prepend numbers to list items' },
      { slug: 'add-prefix-suffix', name: 'Add Prefix / Suffix', description: 'Add text, characters, or quotes to the beginning (prefix) and end (suffix) of every line', icon: '➕', keywords: 'add prefix and suffix to text online, add quotes to every line in list, append text to end of line online' },
      { slug: 'sort-lines', name: 'Sort Lines', description: 'Sort text lines alphabetically (A-Z, Z-A), by length, or case-sensitive', icon: '🔤', keywords: 'alphabetize list online free, sort lines of text alphabetically, sort list by length online' },
      { slug: 'reverse-text', name: 'Reverse Text', description: 'Reverse the characters or words in your text instantly', icon: '🔄', keywords: 'reverse text online free, backwards text generator, flip text upside down online' },
      { slug: 'reverse-lines', name: 'Reverse Lines Order', description: 'Reverse the order of lines in a list', icon: '↕️', keywords: 'reverse list order online free, flip list upside down, reverse lines of text tool' },
    ],
  },
  {
    ...
    color: '#f59e0b',
    tools: [
      { slug: 'base64-encode-decode', name: 'Base64 Encode / Decode', description: 'Encode text, images, and files to Base64 format or decode Base64 strings back to text', icon: '🔑', keywords: 'base64 encode decode online free, convert file to base64 string, base64 url safe encoder' },
      { slug: 'url-encode-decode', name: 'URL Encode / Decode', description: 'Encode or decode URLs and query string parameters instantly', icon: '🔗', keywords: 'url encode decode online free, encodeuri component online, decode url parameters free' },
      { slug: 'html-encode-decode', name: 'HTML Encode / Decode', description: 'Encode special characters into safe HTML entities (like &amp; and &lt;) or decode entities back into readable text', icon: '🏷️', keywords: 'html encode decode online free, convert text to html entities, decode html special characters' },
      { slug: 'binary-text', name: 'Binary ↔ Text', description: 'Translate binary code (0s and 1s) to text, or convert text into binary', icon: '💻', keywords: 'binary to text translator online, convert binary code to english, text to binary converter free' },
      { slug: 'hex-text', name: 'Hex ↔ Text', description: 'Convert hexadecimal (hex) strings into readable text, or translate text into hex code', icon: '🔢', keywords: 'hex to text converter online, hexadecimal translator free, convert text to hex code' },
      { slug: 'octal-text', name: 'Octal ↔ Text', description: 'Convert octal numerical values into readable text or translate text into octal code instantly', icon: '🔟', keywords: 'octal to text converter online, base 8 number translator, convert octal to string' },
      { slug: 'ascii-text', name: 'ASCII ↔ Text', description: 'Translate ASCII code numbers into readable text or convert text into ASCII values', icon: '🅰️', keywords: 'ascii to text converter online, ascii code translator free, convert text to ascii numbers' },
      { slug: 'rot13', name: 'ROT13 Encoder / Decoder', description: 'Encrypt or decrypt text using the classic ROT13 (Rotate by 13 places) substitution cipher', icon: '🔄', keywords: 'rot13 encoder decoder online free, caesar cipher translator, rot13 decryption tool' },
      { slug: 'utf8-encode-decode', name: 'UTF-8 Encode / Decode', description: 'Encode text into UTF-8 byte arrays or decode UTF-8 hex/decimal values back into text', icon: '🌐', keywords: 'utf8 encode decode online free, convert text to utf 8 bytes, unicode hex decoder' },
      { slug: 'morse-code', name: 'Morse Code Translator', description: 'Translate text to Morse code or decode dots and dashes back to English', icon: '📡', keywords: 'morse code translator online, text to dots and dashes, morse code decoder with audio' },
      { slug: 'braille-translator', name: 'Braille Translator', description: 'Translate standard text into Braille unicode characters instantly', icon: '⠃', keywords: 'braille translator online free, convert text to braille unicode, braille generator from english' },
      { slug: 'sign-language-translator', name: 'Sign Language Translator', description: 'Translate text into American Sign Language (ASL) finger-spelling using hand emojis', icon: '🤟', keywords: 'sign language translator online, text to asl hand emojis, finger spelling translator free' },
      { slug: 'nato-phonetic-translator', name: 'NATO Phonetic Translator', description: 'Convert text into the NATO phonetic alphabet (Alpha, Bravo, Charlie) instantly', icon: '✈️', keywords: 'nato phonetic alphabet translator, spell out words with military alphabet, aviation spelling converter free' },
      { slug: 'wingdings-translator', name: 'Wingdings Translator', description: 'Translate regular text into the classic Wingdings symbol font instantly', icon: '🖳', keywords: 'wingdings translator online free, convert text to wingdings symbols, secret symbol font generator' },
    ],
  },
  {
    id: 'code-formatter',
    ...
    color: '#10b981',
    tools: [
      { slug: 'json-formatter', name: 'JSON Formatter', description: 'Format, beautify, and validate your JSON data instantly', icon: '📋', keywords: 'json formatter online free, beautify json code, prettify json string' },
      { slug: 'json-validator', name: 'JSON Validator', description: 'Validate your JSON code instantly', icon: '✅', keywords: 'json validator online free, check json syntax errors, find missing comma in json' },
      { slug: 'json-minifier', name: 'JSON Minifier', description: 'Minify JSON by instantly removing all whitespace, tabs, and line breaks', icon: '📦', keywords: 'json minifier online free, compress json payload, remove whitespace from json' },
      { slug: 'xml-formatter', name: 'XML Formatter', description: 'Format and beautify messy XML code instantly', icon: '📄', keywords: 'xml formatter online free, beautify xml code, pretty print xml string' },
      { slug: 'sql-formatter', name: 'SQL Formatter', description: 'Format messy SQL queries instantly', icon: '🗃️', keywords: 'sql formatter online free, beautify sql queries, pretty print sql statements' },
      { slug: 'html-formatter', name: 'HTML Formatter', description: 'Format messy HTML code instantly', icon: '🌐', keywords: 'html formatter online free, beautify html code, prettify html tags' },
      { slug: 'css-formatter', name: 'CSS Formatter', description: 'Format and beautify CSS code instantly', icon: '🎨', keywords: 'css formatter online free, beautify css code, pretty print css stylesheet' },
      { slug: 'css-minifier', name: 'CSS Minifier', description: 'Minify CSS code to optimize your website load speed', icon: '🗜️', keywords: 'css minifier online free, compress css code, remove whitespace from css' },
      { slug: 'js-formatter', name: 'JavaScript Formatter', description: 'Format messy JavaScript code instantly', icon: '⚡', keywords: 'javascript formatter online free, beautify js code, pretty print javascript' },
      { slug: 'js-minifier', name: 'JavaScript Minifier', description: 'Minify JavaScript code for production', icon: '📦', keywords: 'javascript minifier online free, compress js code, remove whitespace from js' },
      { slug: 'json-to-typescript', name: 'JSON to TypeScript Interfaces', description: 'Convert any JSON payload into perfectly typed TypeScript interfaces and types instantly', icon: '📘', keywords: 'json to typescript converter online free, generate ts interface from json, json to ts types tool' },
      { slug: 'math-equation-latex', name: 'Math Equation Formatter', description: 'Format messy math text into beautiful LaTeX equations instantly', icon: '🧮', keywords: 'math equation formatter online, convert math text to latex, latex equation generator' },
      { slug: 'rpg-stat-block-formatter', name: 'RPG Stat Block Formatter', description: 'Format raw text into beautiful D&D 5e RPG stat blocks instantly', icon: '🐉', keywords: 'dnd 5e stat block generator online, rpg stat block formatter free, dungeons and dragons monster sheet maker' },
    ],
  },
  {
    id: 'text-converter',
  ...
  },
  {
    ...
    color: '#8b5cf6',
    tools: [
      { slug: 'extract-emails', name: 'Extract Emails', description: 'Extract all email addresses from any text, PDF, or document — auto-detects Gmail, Outlook, Yahoo. Group by domain, validate format, export CSV/TXT/JSON. 100% private, no signup.', icon: '📧', keywords: 'extract email addresses from text online free, email extractor from document pdf free, pull emails from text no signup, bulk email extractor paste text online, extract emails from webpage free browser tool, email scraper from text csv download' },
      { slug: 'extract-urls', name: 'Extract URLs', description: 'Extract all URLs and links from any text or HTML — filter by protocol, remove UTM tracking params, group by domain with favicons. Export CSV/JSON. Free, private.', icon: '🔗', keywords: 'extract urls from text online free, link extractor from html free, pull all links from webpage text, url scraper from document no signup, extract hyperlinks from text csv download, remove utm tracking from urls online free' },
      ...
      { slug: 'extract-phones', name: 'Extract Phone Numbers', description: 'Extract phone numbers from any text or document — auto-detects country codes for 28+ countries with flags, E.164 normalization, digits-only mode. Export CSV/JSON. Free, private.', icon: '📱', keywords: 'extract phone numbers from text online free, phone number extractor from document pdf free, pull phone numbers from text no signup, bulk phone extractor paste text csv download, international phone number extractor with country code, extract mobile numbers from text free browser tool' },
      { slug: 'pii-redactor', name: 'PII & Privacy Redactor', description: 'Redact sensitive data (emails, IPs, API keys, CCs, phones) from text instantly. 100% client-side privacy, visual toggle dashboard, and multi-format replacement.', icon: '🛡️', keywords: 'pii redactor online free, redact sensitive data online, remove emails ip credit cards from text, data anonymizer tool, privacy text redactor secure' },
      ...
      { slug: 'regex-tester', name: 'Regex Tester', description: 'Test regular expressions with real-time match highlighting, group capture details, and execution speed. Includes 15+ common patterns and replace mode.', icon: '🧪', keywords: 'regex tester online live highlighting, regular expression tester and debugger, regex replace mode test, regex pattern cheatsheet online' },
  ...
  },
  {
    ...
    color: '#f59e0b',
    tools: [
      { slug: 'uuid-generator', name: 'UUID Generator', description: 'Generate UUID v4, v7, and v1 in bulk — up to 50,000. Decode & validate existing UUIDs. Uppercase, no-hyphens, braces, URN formats. Export TXT/CSV/JSON. Free, browser-based.', icon: '🆔', keywords: 'uuid generator online free bulk v4 v7, generate uuid v7 time-ordered database, random uuid generator bulk download csv, guid generator online braces format, uuid validator decoder online free, uuid v4 vs v7 generator' },
      { slug: 'password-generator', name: 'Password Generator', description: 'Generate strong random passwords and memorable passphrases. Entropy meter, crack time estimation, adjustable length (4-128), character toggles, and bulk generation. 100% client-side.', icon: '🔑', keywords: 'strong password generator online free, random password generator secure, passphrase generator diceware, password entropy calculator, bulk password generator download, generate strong password with symbols' },
      { slug: 'lorem-ipsum', name: 'Lorem Ipsum Generator', description: 'Generate placeholder text in 4 styles: Classic Latin, Hipster, Corporate, and Pirate. Paragraphs, sentences, words, or bullet lists with HTML wrap option. Free, instant.', icon: '📝', keywords: 'lorem ipsum generator online free, placeholder text generator paragraphs, dummy text generator html, hipster ipsum generator, corporate buzzword lorem ipsum' },
      ...
      { slug: 'password-strength', name: 'Password Strength Analyzer', description: 'Analyze password strength with entropy calculation, crack time estimation, 10-point security checklist, and actionable recommendations. 100% offline and private.', icon: '🛡️', keywords: 'password strength checker online free, how strong is my password, password entropy calculator, password security analyzer, check password strength meter, is my password safe checker' },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: 'bcrypt-generator', name: 'Bcrypt Generator & Checker', description: 'Generate and verify Bcrypt hashes securely in your browser — single or batch mode. Adjustable salt rounds with security meter, CSV export for batch results. 100% client-side.', icon: '🛡️', keywords: 'bcrypt generator online free, bcrypt hash checker verifier online, bcrypt password hash generator, batch bcrypt hash generator csv, bcrypt salt rounds calculator, verify bcrypt hash online free secure' },
    ],
  },
  {
    id: 'list-array-tools',
  ...
  },
  {
    ...
    color: '#0ea5e9',
    tools: [
      { slug: 'jwt-decoder', name: 'JWT Decoder', description: 'Decode JSON Web Tokens instantly — color-coded header/payload/signature, live expiry countdown, claim-by-claim breakdown, algorithm detection. 100% client-side, never leaves your browser.', icon: '🔑', keywords: 'jwt decoder online free, decode json web token online, jwt debugger token inspector, jwt expiry checker online, jwt token viewer claims decoder, jwt.io alternative free private' },
      { slug: 'color-converter', name: 'Color Converter', description: 'Convert between HEX, RGB, HSL, HSV, CMYK with live preview. WCAG accessibility checker, color harmonies, shades & tints palette. Copy as CSS variable or Tailwind class.', icon: '🎨', keywords: 'hex to rgb converter online free, color converter hex rgb hsl cmyk, wcag contrast checker color, color palette generator harmonies, hsl to hex converter online, color picker converter tool free' },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: 'pdf-text-editor', name: 'PDF Editor', description: 'Edit text, annotate, sign and redact PDF files free online — no upload, 100% private', icon: '✏️', keywords: 'edit pdf online free no upload, pdf editor browser free, free online pdf editor no watermark, edit text in pdf free, pdf editor online free no watermark no signup, edit pdf without adobe acrobat, how to edit text in pdf file online for free, best free pdf editor 2026, sign pdf online free, merge pdf free, compress pdf free, edit scanned pdf free ocr, pdf form filler free, redact pdf free, edit pdf on phone free, smallpdf alternative free, sejda alternative free no limit, ilovepdf alternative, pdf editor with find and replace, edit pdf resume invoice free, browser based pdf editor free, pdf editor unlimited pages free, pdf editor safe secure private, free pdf annotator online, edit pdf without uploading to server, password protect pdf free, add watermark to pdf free, pdf editor chromebook iphone ipad free' },
      { slug: 'merge-pdf', name: 'Merge PDF', description: 'Combine multiple PDF files in your chosen order — free, private, no upload or watermark', icon: '🔗', keywords: 'merge pdf online free, combine pdf files free, join pdfs online no upload, merge pdf no watermark free' },
      ...
      { slug: 'flipbook-maker', name: 'PDF Flipbook Maker', description: 'Turn a PDF into an interactive flipbook with templates and portable HTML export — free and private', icon: '📖', keywords: 'free flipbook maker, pdf to flipbook online, interactive pdf viewer, digital catalog maker, html flipbook creator' },
      { slug: 'pdf-to-word', name: 'PDF to Word Converter', description: 'Convert PDF to editable Word document (.docx) or plain text free — no server upload, preserves text layout, no page limit.', icon: '📝', keywords: 'pdf to word converter free online, convert pdf to docx free no signup, pdf to word free no watermark, extract text from pdf to word, pdf to editable document free browser' },
    ],
  },
  {
    id: 'premium-pdf-tools',
    name: 'Premium PDF Tools',
    description: 'Advanced PDF processing — batch operations, table extraction, OCR, redaction, watermark removal, AI summarizer, and compression. Freemium: basic uses free, unlimited with Pro.',
    icon: '⚡',
    color: '#7c3aed',
    tools: [
      { slug: 'batch-pdf-processor', name: 'Batch PDF Processor', description: 'Upload up to 50 PDFs at once — extract text, merge, convert to JPG, or compress in one click. Download results as ZIP.', icon: '📑', pro: true, keywords: 'batch pdf processor online free, bulk pdf converter, process multiple pdfs at once, batch pdf to text extractor, mass pdf merge tool free' },
      { slug: 'pdf-to-excel', name: 'PDF to Excel', description: 'Convert PDF tables to Excel (.xlsx) with smart column detection — bank statements, invoices, reports. Auto-detects rows and columns.', icon: '📊', pro: true, keywords: 'pdf to excel converter free online, convert pdf table to excel, pdf to xlsx free, extract table from pdf to spreadsheet, bank statement pdf to excel free' },
      { slug: 'ocr-unlimited', name: 'OCR for Scanned PDFs', description: 'Extract text from scanned PDFs using high-resolution OCR — 12 languages including Hindi, Arabic, Chinese. Export as text or Word doc.', icon: '🔍', pro: true, keywords: 'ocr pdf free online, scanned pdf to text converter free, pdf ocr online free no limit, extract text from scanned document free, hindi ocr pdf online free' },
      { slug: 'pdf-redactor', name: 'PDF Redaction Tool', description: 'Permanently black out sensitive information in PDFs — auto-detects emails, phone numbers, Aadhaar, PAN, credit cards. Draw or auto-redact.', icon: '🔒', pro: true, keywords: 'redact pdf online free, black out text in pdf free, pdf redaction tool aadhaar pan, remove sensitive info from pdf, pdf pii remover free' },
      { slug: 'pdf-watermark-remover', name: 'PDF Watermark Remover', description: 'Detect and remove text watermarks from PDFs — DRAFT, CONFIDENTIAL, SAMPLE and custom text. Before/after preview.', icon: '💧', pro: true, keywords: 'remove watermark from pdf free online, pdf watermark remover free, delete watermark pdf online, remove draft watermark from pdf, remove confidential stamp pdf' },
      { slug: 'pdf-summarizer', name: 'AI PDF Summarizer', description: 'Get a concise summary of any long PDF — research papers, reports, legal documents. Adjustable length, key findings, bullet points. 100% offline.', icon: '🤖', pro: true, keywords: 'summarize pdf online free, pdf summarizer ai free, ai summary of pdf document, pdf to summary converter, summarize research paper pdf free' },
      { slug: 'pdf-compressor', name: 'PDF Compressor', description: 'Reduce PDF file size with 3 quality levels — batch compress multiple files. Before/after size comparison. No upload to servers.', icon: '📦', pro: true, keywords: 'compress pdf online free, reduce pdf file size free, shrink pdf without quality loss, batch pdf compressor free, pdf file size reducer online' },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: 'Build a professional resume online free — 5 templates, live preview, PDF download with no watermark. No signup required.',
        icon: '📄',
      ...
      },
      {
        ...
        name: 'Job Application Auto-Pack',
        description: 'Paste your resume + job description → auto-generates tailored resume, cover letter, HR email, LinkedIn message & follow-up email. Download all 5 as .docx files in one ZIP. ATS keyword scoring. 100% private, free.',
        icon: '🚀',
        keywords: 'job application pack generator free, tailored resume cover letter generator, ats resume keyword optimizer free, job application email generator, linkedin message recruiter template free, cover letter generator from job description, resume keyword matcher free online, job application automation tool, how to tailor resume to job description free, ats friendly resume generator no signup',
      },
    ],
  }
  ,
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: 'png-to-jpg', name: 'PNG to JPG', description: 'Convert PNG images to JPG format online free', icon: '🖼️', keywords: 'png to jpg converter free online, convert png to jpg without losing quality' },
      { slug: 'jpg-to-png', name: 'JPG to PNG', description: 'Convert JPG images to transparent PNG online free', icon: '🖼️', keywords: 'jpg to png converter transparent background free' },
      { slug: 'webp-to-jpg', name: 'WebP to JPG', description: 'Convert WebP images to JPG format online free', icon: '🖼️', keywords: 'webp to jpg converter free, how to save webp as jpg' },
      { slug: 'webp-to-png', name: 'WebP to PNG', description: 'Convert WebP images to PNG format online free', icon: '🖼️', keywords: 'webp to png converter transparent free' },
      { slug: 'jpg-to-webp', name: 'JPG to WebP', description: 'Convert JPG images to WebP format online free', icon: '🖼️', keywords: 'jpg to webp converter reduce file size' },
      { slug: 'png-to-webp', name: 'PNG to WebP', description: 'Convert PNG images to WebP format online free', icon: '🖼️', keywords: 'png to webp converter free' },
      { slug: 'svg-to-png', name: 'SVG to PNG', description: 'Convert SVG vector graphics to PNG images online free', icon: '🖼️', keywords: 'svg to png converter high resolution free' },
      { slug: 'svg-to-jpg', name: 'SVG to JPG', description: 'Convert SVG vector graphics to JPG images online free', icon: '🖼️', keywords: 'svg to jpg converter free online' },
      { slug: 'image-to-base64', name: 'Image to Base64', description: 'Convert image files to Base64 string online free', icon: '🔤', keywords: 'image to base64 converter online free' },
      { slug: 'base64-to-image', name: 'Base64 to Image', description: 'Decode Base64 string to image file online free', icon: '🖼️', keywords: 'base64 to image decoder online free' },
      { slug: 'image-to-pdf', name: 'Image to PDF', description: 'Convert any image format to PDF online free', icon: '📄', keywords: 'image to pdf converter free online' },
      { slug: 'heic-to-png', name: 'HEIC to PNG', description: 'Convert iPhone HEIC images to PNG online free', icon: '📱', keywords: 'heic to png converter free iphone' },
      { slug: 'gif-to-png', name: 'GIF to PNG', description: 'Convert GIF animations to PNG images online free', icon: '🖼️', keywords: 'gif to png frame converter free' },
      { slug: 'bmp-to-jpg', name: 'BMP to JPG', description: 'Convert BMP bitmaps to JPG images online free', icon: '🖼️', keywords: 'bmp to jpg converter free online' },
      { slug: 'ico-to-png', name: 'ICO to PNG', description: 'Convert ICO icons to PNG images online free', icon: '🖼️', keywords: 'ico to png converter free online' },
      {
        slug: 'jpg-to-pdf',
        name: 'JPG to PDF',
      ...
      },
      {
        ...
        description: 'Remove image background instantly and free — PNG with transparency or custom color. No server upload, no signup, works offline.',
        icon: '🎭',
      ...
      },
      {
        ...
        description: 'Convert iPhone HEIC photos to JPG or PNG free online — bulk convert, no upload, instant download.',
        icon: '📱',
      ...
      },
      {
        ...
        description: 'Make passport photos for India, US, UK, Schengen — 35x45mm, white background, 300 DPI, print-ready 4x6 sheet. Free, no signup.',
        icon: '🪪',
      ...
      },
      {
        slug: 'meme-generator',
        name: 'Meme Generator',
        description: 'Create memes online free — upload any image or use templates, add top/bottom text, download PNG. No watermark, no signup.',
        icon: '😂',
  ...
  },
  {
    ...
    description: 'Free offline unit conversion calculators for length, weight, temperature, area, volume, speed, and time.',
    icon: '📏',
    color: '#10b981',
    tools: [
      { slug: 'length-converter', name: 'Length Converter', description: 'Convert between meters, feet, inches, miles, and kilometers online.', icon: '📏', keywords: 'length converter, distance calculator' },
      { slug: 'weight-converter', name: 'Weight Converter', description: 'Convert between kilograms, pounds, ounces, and grams online.', icon: '⚖️', keywords: 'weight converter, mass calculator' },
      { slug: 'temperature-converter', name: 'Temperature Converter', description: 'Convert between Celsius, Fahrenheit, and Kelvin online.', icon: '🌡️', keywords: 'temperature converter, c to f' },
      { slug: 'area-converter', name: 'Area Converter', description: 'Convert between square meters, acres, hectares, and square feet online.', icon: '📐', keywords: 'area converter, square foot calculator' },
      { slug: 'volume-converter', name: 'Volume Converter', description: 'Convert between liters, gallons, cups, and fluid ounces online.', icon: '💧', keywords: 'volume converter, liquid calculator' },
      { slug: 'speed-converter', name: 'Speed Converter', description: 'Convert between mph, km/h, knots, and m/s online.', icon: '🏎️', keywords: 'speed converter, mph to kph' },
      { slug: 'time-converter', name: 'Time Converter', description: 'Convert between seconds, minutes, hours, days, and years online.', icon: '⏱️', keywords: 'time converter, minutes to hours' },
      { slug: 'data-storage-converter', name: 'Data Storage Converter', description: 'Convert between MB, GB, TB, and KB online.', icon: '💾', keywords: 'data storage converter, mb to gb' },
      { slug: 'pressure-converter', name: 'Pressure Converter', description: 'Convert between bar, psi, pascal, and atm online.', icon: '🗜️', keywords: 'pressure converter, psi to bar' },
      { slug: 'energy-converter', name: 'Energy Converter', description: 'Convert between joules, calories, and kWh online.', icon: '⚡', keywords: 'energy converter, joules to calories' },
      { slug: 'power-converter', name: 'Power Converter', description: 'Convert between watts, kilowatts, and horsepower online.', icon: '🔌', keywords: 'power converter, watts to hp' },
      { slug: 'angle-converter', name: 'Angle Converter', description: 'Convert between degrees, radians, and gradians online.', icon: '📐', keywords: 'angle converter, degrees to radians' }
    ]
  },
    {
    id: 'finance-tools',
    ...
    tools: [
      ...
      },
      {
        ...
        description: 'Analyze any lease, employment, or general contract instantly. Detects hidden risks, unfavorable clauses, and auto-renewals in seconds. 100% private, runs entirely in your browser.',
        icon: '⚖️',
        keywords: 'ai contract analyzer free online, analyze lease agreement online, employment contract checker, read nda online free, ai legal contract reviewer, analyze contract pdf',
      },
      {
        slug: 'bank-statement-financial-report',
        name: 'Bank Statement Financial Report',
        description: 'Upload any bank statement PDF or CSV → auto-categorizes transactions, detects subscriptions & money leaks, shows monthly income vs expense charts, financial health score, and exports a full 5-sheet Excel report. Works with 500+ banks worldwide. 100% private, no upload to servers.',
        icon: '💹',
        keywords: 'bank statement financial report generator free, bank statement analyzer pdf to excel free, personal finance report from bank statement, bank statement spending analysis free online, subscription detector bank statement, monthly expense report generator free, bank statement csv to excel with charts, personal finance tracker from bank statement, bank statement income expense analysis free, free bank statement analyzer no upload no signup',
      },
    ],
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: 'Generate income certificate in standard India format — all states, SDM/Tehsildar format, amount in words auto-generated, PDF download. Free, no signup, 100% private.',
        icon: '📜',
      ...
      },
      {
        ...
        description: 'Fill EPF Form 19 for final PF settlement — UAN, establishment, bank NEFT details, reason for leaving. Preview and download PDF. Free, 100% private.',
        icon: '🏦',
      ...
      },
      {
        ...
        name: 'Form 16 Tax Calculator — Old vs New Regime',
  ...
  {
    id: 'video-converter-tools',
    name: 'Video Converter Tools',
    description: 'Convert, compress, and transform videos entirely in your browser. MP4, MOV, MKV, WebM, AVI — extract audio, create GIFs, generate subtitles, resize for social media. 100% private, no upload to servers.',
    icon: '🎬',
    color: '#7c3aed',
    tools: [
      { slug: 'video-to-mp3',      name: 'Video to MP3',               description: 'Extract MP3 audio from any video file — MP4, MOV, MKV, WebM. Fast, free, 100% private.', icon: '🎵', keywords: 'video to mp3 converter online free, extract audio from video, mp4 to mp3 free no signup' },
      { slug: 'mp4-to-mp3',        name: 'MP4 to MP3',                  description: 'Convert MP4 video to MP3 audio instantly in your browser. Choose bitrate, no file size limit.', icon: '🎵', keywords: 'mp4 to mp3 converter free online, convert mp4 to mp3 no signup' },
      { slug: 'video-to-gif',      name: 'Video to GIF',                description: 'Convert any video clip to an animated GIF. Trim start/end, set FPS and size. No upload needed.', icon: '🎞️', keywords: 'video to gif converter free online, mp4 to gif no signup browser' },
      { slug: 'mp4-converter',     name: 'Video Format Converter',      description: 'Convert between MP4, MOV, WebM, MKV, AVI and more. All conversions run in your browser.', icon: '🔄', keywords: 'video format converter online free, mp4 converter no signup, convert mov to mp4 free' },
      { slug: 'video-compressor',  name: 'Video Compressor',            description: 'Compress video files without losing quality. Reduce file size for sharing, email, or web. Free.', icon: '📦', keywords: 'video compressor online free no upload, compress mp4 online, reduce video file size free' },
      { slug: 'video-to-frames',   name: 'Video to Frames',             description: 'Extract individual frames from any video as PNG images. Set interval — every second, 1fps, 5fps.', icon: '🖼️', keywords: 'video to frames extractor online free, extract frames from video, screenshot from video' },
      { slug: 'video-transcript',  name: 'Video to Transcript',         description: 'Auto-transcribe speech in your video to plain text using AI. Supports 30+ languages. Free, private.', icon: '📝', keywords: 'video to transcript free online, transcribe video to text, video speech to text free' },
      { slug: 'video-to-srt',      name: 'Video to SRT Subtitles',      description: 'Generate timed SRT subtitle files from any video. AI transcription with precise timestamps. Free.', icon: '📋', keywords: 'video to srt free online, generate subtitles from video, srt subtitle generator free' },
      { slug: 'video-to-vtt',      name: 'Video to VTT Subtitles',      description: 'Generate WebVTT subtitle files from video. Perfect for web players and HTML5 video. Free.', icon: '💬', keywords: 'video to vtt free online, webvtt subtitle generator, html5 video subtitles free' },
      { slug: 'video-resize',      name: 'Video Resizer',               description: 'Resize video to any dimension — 1080p, 720p, 4K, or custom. Crop for social media aspect ratios.', icon: '📐', keywords: 'resize video online free, video resizer no upload, change video resolution free' },
      { slug: 'video-to-vertical', name: 'Landscape to Vertical 9:16',  description: 'Convert landscape video to vertical 9:16 for TikTok, Instagram Reels, and YouTube Shorts. Free.', icon: '📱', keywords: 'landscape to vertical video converter free, video to 9:16 tiktok reels, rotate video online free' },
      { slug: 'video-crop',        name: 'Video Cropper',               description: 'Crop video to any aspect ratio — square 1:1, portrait 4:5, landscape 16:9. Free, browser-based.', icon: '✂️', keywords: 'video cropper online free, crop video online no signup, video aspect ratio changer' },
      { slug: 'video-trim',        name: 'Video Trimmer',               description: 'Trim and cut video files to any length. Remove unwanted start/end sections. Fast, free, no upload.', icon: '🎬', keywords: 'video trimmer online free no signup, cut video online, trim mp4 free browser' },
    ],
  },
];
