...
export const CATEGORIES = [
  ...
  },
  {
    ...
    color: '#6366f1',
    tools: [
      { slug: 'uppercase', name: 'Uppercase Converter', description: 'Convert text to UPPERCASE with locale-aware rules and optional URL or email protection', icon: '⬆️', keywords: 'convert text to uppercase online free capital letters converter' },
      { slug: 'lowercase', name: 'Lowercase Converter', description: 'Change capital letters to lowercase with locale-aware rules and optional URL or email protection', icon: '⬇️', keywords: 'convert uppercase to lowercase online free small letters converter' },
      { slug: 'title-case', name: 'Title Case Converter', description: 'Compare general, AP-style, APA-style, Chicago-style, and MLA-style title capitalization', icon: '📝', keywords: 'title case converter AP APA Chicago MLA online' },
