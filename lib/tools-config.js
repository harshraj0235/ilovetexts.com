...
export const CATEGORIES = [
  ...
  },
  {
    ...
    color: '#f59e0b',
    tools: [
      { slug: 'base64-encode-decode', name: 'Base64 Encode / Decode', description: 'Encode or decode Base64 text with URL-safe mode (RFC 4648), MIME line breaks, UTF-8 support, file upload, and byte size stats. Swap between encode/decode instantly.', icon: '🔑', keywords: 'base64 encode decode online free, base64 encoder decoder tool, base64 url safe encode, convert text to base64 utf8, base64 file encoder online' },
      { slug: 'url-encode-decode', name: 'URL Encode / Decode', description: 'Encode or decode URLs instantly. Supports URI Component encoding, auto-detection, query string table parser, and swap button. 100% free and private.', icon: '🔗', keywords: 'url encode decode online free, url encoder decoder tool, url component encoder, decode url parameters, query string parser online' },
      { slug: 'html-encode-decode', name: 'HTML Encode / Decode', description: 'Encode characters to HTML entities and back. 3 encoding levels (Basic, ASCII, Unicode), safe DOM parser decoding, and live HTML rendering preview.', icon: '🏷️', keywords: 'html entity encode decode online, html encoder decoder tool, convert text to html entities, unescape html online free, decode html characters tool' },
      ...
      { slug: 'morse-code', name: 'Morse Code Translator', description: 'Convert text to Morse code and back with audio playback. Visual dot/dash display, adjustable speed, swap button, and full A-Z 0-9 reference chart. Free and instant.', icon: '📡', keywords: 'text to morse code translator online free, morse code converter with audio, morse code translator with sound, morse code decoder online, learn morse code online free' },
