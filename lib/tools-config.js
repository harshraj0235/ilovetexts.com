  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        name: 'Contract Analyzer — Lease & Employment Contract Plain English',
        description: 'Analyze any contract in plain English free. Detects red flags in leases, employment contracts, NDAs. 200+ risk patterns, country-specific advice for US/UK/India/Germany. No AI server, 100% private.',
        icon: '⚖️',
        keywords: 'contract analyzer plain english free online, lease agreement red flags checker free, employment contract risk analyzer free, understand my contract free tool, rental agreement analyzer no upload, job offer contract checker free',
      },
    ],
  },
  {
