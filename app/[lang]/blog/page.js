...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: generateAlternates(lang, '/blog'),
  };
}
...
- [URL Encoder](/text-encoder-decoder/url-encode-decode) — JWTs are URL-safe
  ...
  },
  {
    ...
    title: 'Free Online Word Counter — Count Words, Characters & More (2026)',
    description: 'The ultimate guide to counting words online. Learn how word count affects SEO, academic requirements, and social media limits. Free tool included.',
    category: 'Guides',
    date: '2026-10-01',
    readTime: '8 min',
    toolLinks: [
      { slug: 'word-counting-tools/word-counter', name: 'Word Counter' },
      { slug: 'word-counting-tools/character-counter', name: 'Character Counter' },
      { slug: 'word-counter/keyword-density', name: 'Keyword Density Checker' },
    ],
    content: `
